...
class Kptraj3dDeformAffordanceDataset(Dataset):
    def __init__(self, dataset_dir, num_steps=40, wpt_dim=3, sample_num_points=1000, device='cuda', with_noise=False):
        
        assert os.path.exists(dataset_dir), f'{dataset_dir} not exists'
        assert wpt_dim == 3, f'wpt_dim should be 3'
