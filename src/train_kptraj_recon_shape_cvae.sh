...
model_configs=(
    ...
    "traj_recon_shape_cvae_kl_annealing"
)
...
# traj_recon_shape_datasets=(
#     "../data/traj_recon_shape/hook-keypoint_trajectory_1104_aug-absolute-30-2023.01.11.21.39"
#     "../data/traj_recon_shape/hook-keypoint_trajectory_1104_aug-residual-30-2023.01.11.21.41"
#     "../data/traj_recon_shape/hook-keypoint_trajectory_1104-absolute-30-2023.01.11.21.39"
#     "../data/traj_recon_shape/hook-keypoint_trajectory_1104-residual-30-2023.01.11.21.39"
# )
