...
if [ $1 = 'train' ]; then 
    ...
    model_configs=(
        ...
        "traj_fusion_mutual_samp"
        "traj_fusion_mutual_samp"
        "traj_fusion_mutual_samp"
        "traj_fusion_mutual_samp"

        "traj_fusion_mutual_samp_nn_dist_mr"
        "traj_fusion_mutual_samp_nn_dist_mr"
        "traj_fusion_mutual_samp_nn_dist_mr"
        "traj_fusion_mutual_samp_nn_dist_mr"

        "traj_fusion_mutual_samp_10"
        "traj_fusion_mutual_samp_10"
        "traj_fusion_mutual_samp_10"
        "traj_fusion_mutual_samp_10"

        "traj_fusion_mutual_samp_nn_dist_mr_10"
        "traj_fusion_mutual_samp_nn_dist_mr_10"
        "traj_fusion_mutual_samp_nn_dist_mr_10"
        "traj_fusion_mutual_samp_nn_dist_mr_10"

        "traj_fusion_mutual_samp_20"
        "traj_fusion_mutual_samp_20"
        "traj_fusion_mutual_samp_20"
        "traj_fusion_mutual_samp_20"

        "traj_fusion_mutual_samp_nn_dist_mr_20"
        "traj_fusion_mutual_samp_nn_dist_mr_20"
        "traj_fusion_mutual_samp_nn_dist_mr_20"
        "traj_fusion_mutual_samp_nn_dist_mr_20"
