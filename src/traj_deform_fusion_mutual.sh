...
if [ $1 = 'train' ]; then 
    ...
    do
        ...
        if [ $log = 'save' ]; then 
            ...
            CUDA_VISIBLE_DEVICES=2 python3 train_kptraj_deform_mutual.py --dataset_dir $traj_recon_affordance_dataset --training_tag $training_tag --config "../config/traj_deform_mutual/${model_config}.yaml" #> $output_log
